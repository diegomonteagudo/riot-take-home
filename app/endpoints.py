...
@router.post("/sign", response_model=SignatureResponse, summary="Sign any JSON payload")
...
@router.post(
    "/verify", status_code=204, summary="Verify the signature of any JSON payload"
)
